    ...
    <>
        ...
        <div className="container mt-5 text-center">
          ...
          <div className="row align-items-center">
            ...
            <div className="col-md-6 order-md-1">
              <p className="lead fs-25 text-black" style={{ opacity: textOpacity }}>
                Foodie is your gourmet buddy in the realm of flavours and
                culinary adventures. We are a dedicated group of foodies who
                think that food has the potential to bring people together,
                stimulate creativity, and provide joy to everyday life.
              </p>
              <p className="text-black" style={{ opacity: textOpacity }}>
      ...
      <div className="row mt-5">
        <div className="col-md-6">
          <h2 className="text-primary text-black" style={{ opacity: textOpacity }}>
            Our Vision
          </h2>
          <p className="text-black" style={{ opacity: textOpacity }}>
